<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="TotalReport.aspx.cs" Inherits="TotalReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
            Sangam Report<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Operations</a></li>
            <li><a href="#">Sangam Report</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Sangam Report Details
                </h3>
            </div>
            <div class="box-body">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:DropDownList ID="ddlReportType" runat="server" CssClass="form-control">
                                        ...
                                        <asp:ListItem>Leakages</asp:ListItem>
                                        <asp:ListItem>Returns</asp:ListItem>
                                        <asp:ListItem>Shortages</asp:ListItem>
                                        <asp:ListItem>Milk Consolidated</asp:ListItem>
                                        <asp:ListItem>Curd Consolidated</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                            ...
                            <div id="divPrint">
                                <div style="width: 100%;">
                                    <div style="width: 11%; float: left;">
                                        <img src="http://www.vyshnavi.co.in/Images/Vyshnavilogo.png" alt="Vyshnavi" width="120px" height="82px" />
                                    </div>
                                    <div style="left: 0%; text-align: center;">
                                        ...
                                        <br />
                                        <div style="width: 100%;">
                                            <asp:Label ID="txttitle" runat="server" Style="font-size: 18px; font-weight: bold;
                                                text-decoration: underline; color: #0252aa;" Text=""></asp:Label>
                                            <div>
                                            </div>
                                        </div>
                                        <div align="center">

...
<body>
    ...
    <section class="container">
        <div class="login" id="content_left" style="top: 3%; position: absolute; z-index: 99;"
            align="center">
            <p>
                <asp:TextBox name="txtUserName" type="text" ID="txtUserName" runat="server" placeholder="Enter UserName" /></p>
            <p style="height: 0px;">
            ...
            <span style="font-size: 14px;">Powered by Vyshnavi</span>

            <br />
            <br />
              <div >
               <a target="_blank" href='https://play.google.com/store/apps/details?id=io.cordova.myappef70e6'><img alt='Get it on Google Play' style="width:210px;height:85px;" src="Images/googleplay.png" /></a>
                </div>

                  <div>
      <span style="color:Red;font-size:18px;">  Dear Sales Users,<br /> Kindly check Beta Version <br />  <a href="http://m.vyshnavi.co.in/" target="_blank" style="color:#3c8dbc;font-size:20px;font-weight:bold;">M.Vyshnavi.Co.In</span>
        </div>
        </div>
